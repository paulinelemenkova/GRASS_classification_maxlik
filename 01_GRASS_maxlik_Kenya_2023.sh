...
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B1.TIF output=L8_2023_01 resample=bilinear extent=region resolution=region --overwrite
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B2.TIF output=L8_2023_02 resample=bilinear extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B3.TIF output=L8_2023_03 resample=bilinear extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B4.TIF output=L8_2023_04 resample=bilinear extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B5.TIF output=L8_2023_05 resample=bilinear extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B6.TIF output=L8_2023_06 resample=bilinear extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Kenya_2023/LC09_L2SP_167059_20230128_20230309_02_T1_SR_B7.TIF output=L8_2023_07 resample=bilinear extent=region resolution=region
...
i.maxlik group=L8_2023 subgroup=res_30m \
  signaturefile=cluster_L8_2023 \
  output=L8_2023_cluster_classes reject=L8_2023_cluster_reject
#
# 6. Mapping
d.mon wx0
g.region raster=L8_2023_cluster_classes -p
r.colors L8_2023_cluster_classes color=bcyr -e
...
d.out.file output=Kenya_2023 format=jpg --overwrite
#
d.mon wx1
g.region raster=L8_2023_cluster_classes -p
...
d.out.file output=Kenya_2023_reject format=jpg --overwrite
...
r.composite blue=L8_2023_03 green=L8_2023_04 red=L8_2023_05 \
            output=L8_2023_rgb_FCC
d.mon wx0
g.region raster=L8_2023_rgb_FCC -p
d.rast L8_2023_rgb_FCC
d.out.file output=L8_2023_rgb_FCC format=jpg --overwrite
...
r.composite blue=L8_2023_02 green=L8_2023_03 red=L8_2023_04 \
            output=L8_2023_rgb_TCC
d.mon wx0
g.region raster=L8_2023_rgb_TCC -p
d.rast L8_2023_rgb_TCC
d.out.file output=L8_2023_rgb_TCC format=jpg --overwrite
